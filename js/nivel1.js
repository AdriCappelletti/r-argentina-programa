...
// const circunferenciaTierraKm = 6371;
// alert('La circunferencia de la tierra es ' + circunferenciaTierraKm + ' km')
...
// let anioNacimiento = prompt('Cuando nacieste papu?');
// let anioActual = prompt('que año es?', '2020');
...
////////////////////////////////////////////////////////////////// 
// function tuedad(anioActual, anioNacimiento){                     //
// return anioActual - anioNacimiento;                          //
// }                                                                // 
//
// let nacimiento = prompt('Cual es tu año de nacimiento?')
// let anio = prompt('que año estamos?', '2020')

// alert('tu edad es ' + tuedad(anio, nacimiento))

// Salario anual

// function calculoMensual(salarioAnual) {
//     return salarioAnual / 12;
// }

// let salarioAnual = prompt('cual es tu salario anual?')

// alert('Tu salario mensual es de ' + calculoMensual(salarioAnual))

// // salario mensual

// function calculoAnual(salarioMensual) {
//     return salarioMensual * 12;
// }

// let salarioMensual = prompt('cual es tu salario mensual?')

// alert('tu salario anual es de ' + calculoAnual(salarioMensual))

// // salario semanal

// function calculoSemanal(salarioMensual) {
//     return salarioMensual / 28
// }

// let salarioMensual = prompt('Cual es tu salario mensual?')

// alert('Tu salario semanal es de ' + calculoSemanal(salarioMensual))

// // Salario diario

// function calculoDiario(salarioSemanal) {
//     return salarioSemanal / 5
// }

// let salarioSemanal = prompt('Cual es tu salario semanal? ')

// alert('Tu salario diario es de ' + calculoDiario(salarioSemanal))
...
// let anioActual = prompt('que año estamos?', '2020')
// alert('tu edad es ' + calcularEdad(anioActual, nacimiento))
...
// } else if (operador === '/') {
//     resultado = deividir(numero1 / numero2)
// } else if (operador === '*') {
...
// let edadUsuario = Number(prompt('cual es tu edad? ', 'Ej: 23'));
// const miEdad = 23;

// if (edadUsuario === miEdad) {
//     console.log('Tenemos la misma edad!')
// } else if (edadUsuario === 0) {
//     console.log('Necesito saber tu edad!')
...
if (documentoUsuario === 'si') {
    let edadUsuario = Number(prompt('Un paso mas! cual es tu edad?'))
    ...
    if (edadUsuario >= edadMinima){
        ...
        alert('Ese no es un dato valido. Intenta de nuevo!')
    }
}

if (documentoUsuario === 'no') {
    alert('Necesitas tener tu documento para ingresar')
} else{
    alert('Ese no es un dato valido. Intenta de nuevo!')
}
